...
key.setViewKey("<delete>", function (ev) {
    BrowserCloseTabOrWindow();
}, 'Close tab / window', false);

key.setGlobalKey("C-_", function (ev) {
    BrowserCloseTabOrWindow();
}, 'Close tab / window', false);
...
// tabgroup
key.setGlobalKey('C-M-L', function (ev) {
    ext.exec("tabgroup-next");
}, 'Select next tabgroup', false);

key.setGlobalKey('C-M-H', function (ev) {
    ext.exec("tabgroup-previous");
}, 'Select previous tab', false);

key.setViewKey('L', function (ev) {
    ext.exec("tabgroup-next");
}, 'Select next tabgroup', true);

key.setViewKey('H', function (ev) {
    ext.exec("tabgroup-previous");
}, 'Select previous tabgroup', true);

key.setViewKey('N', function (ev) {
    ext.exec("tabgroup-create");
}, 'Create new tabgroup', true);

key.setGlobalKey(["C-x", "K"], function (ev) {
    ext.exec("tabgroup-close");
}, 'Close the tabgroup', false);
